...
| 2 | The token bill in plain English | `token-cost-calculator.xlsx` | Calculator | In progress |
| 3 | Architecture beats the discount | `model-routing-skill.md` | Skill | Planned |
